...
<div class="menu">
    <a href="javascript:;" class="closem">
        <img src="<?php echo URLIMGS . "/menu.svg" ?>" alt="">
    </a>
    <nav>
        <h4><?=$user['fullname']?></h4>
...
<main>
        <header class="nav level-0">
            <a href="">
                <img src="<?php echo URLIMGS . "/flecha.svg" ?>" alt="Back">
            </a>
        ...
        <section class="dashboard">
            ...
            <menu>
                <ul>
                    <li>
                        <a href="#">
                            <img src="<?php echo URLIMGS . "/persona.svg" ?>" alt="Users">
                            <span>Module User</span>    
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo URLIMGS . "/pata.svg" ?>" alt="Pets">
                            <span>Module Pets</span>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="<?php echo URLIMGS . "/chulo.svg" ?>" alt="Adoptions">
